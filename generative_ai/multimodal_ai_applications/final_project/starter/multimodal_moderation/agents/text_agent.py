...
Assess each flag independently. The presence of PII does not by itself make the
message unfriendly or unprofessional; base the tone flags only on the wording,
style, and manner of communication.
</instructions>
