...
Evaluate image quality carefully even when the subject remains recognizable. Set
is_low_quality to True when the main subject, fine details, edges, or visible text
are noticeably soft, out of focus, blurred, pixelated, or poorly exposed.
